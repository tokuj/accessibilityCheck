...
- [x] 1. .gitignoreの設定修正
- [x] 1.1 package-lock.jsonをバージョン管理対象に含める
...
- [x] 1.2 ルートおよびフロントエンドのpackage-lock.jsonをステージング
...
- [x] 2. (P) 導入ドキュメントの作成
- [x] 2.1 (P) GitHub Actions CIガイドドキュメントの作成
...
- [x] 2.2 (P) ドキュメントインデックスの更新
  - `docs/README.md`のドキュメント一覧にGitHub Actions CIガイドを追加
  - 既存のテーブル形式に従って行を追加
  - _Requirements: 4.5_

- [x] 3. 既存テスト構成の確認
- [x] 3.1 アクセシビリティテストのWCAG準拠設定を確認
...
- [x] 3.2 GitHub Actionsワークフロー設定を確認
