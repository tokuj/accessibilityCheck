...
- [ ] 6.1 ダウンロード通知用Snackbarをレポート画面に統合
...
- [ ] 7.1 モバイルブラウザでのダウンロード動作確認とE2Eテスト
