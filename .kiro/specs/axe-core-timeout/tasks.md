...
- [ ] 2. Playwrightリソースブロック機能の実装
- [ ] 2.1 広告リクエストブロック機能の作成
...
- [ ] 8. CLIテスト設定の更新
- [ ] 8.1 playwright.config.tsの更新
  - グローバルテストタイムアウトを180秒に設定する
  - アクションタイムアウトを90秒に設定する
  - _Requirements: 6.1, 6.2_

- [ ] 8.2 accessibility.spec.tsの更新
